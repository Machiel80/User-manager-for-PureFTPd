...
$ConfigVersion = "Version 2.5";

// ini_set('display_errors', 'On');

require('includes/sql.php');

#[NoReturn] function end_session($error_message) {
...
if ($stage == 'stage_4_configuration_file') {
	if (isset($_POST['save'])) {
		...
		$filecontent .= "<?php\n";
		$filecontent .= "  /* 'User manager for PureFTPd' is made by M.Mastenbroek 2002 - 2005, dnsb 2022\n";
...
if ($stage == 'stage_5_configure_administrators') {
	...
	if (isset($_POST["admin_current_id"]) &&
		...
		} elseif (isset($_POST["admin_current_delete"])) {
...
} elseif ($stage == 'stage_2_new_database') {
	echo("<tr>\n");
	echo("<td width=\"60%\">&nbsp;</td>\n");
	echo("<td width=\"30%\">&nbsp;</td>\n");
	echo("<td width=\"10%\">&nbsp;</td>\n");
...
} elseif ($stage == 'stage_3_create_database') {
	echo("<tr>\n");
	echo("<td width=\"60%\">&nbsp;</td>\n");
	echo("<td width=\"30%\">&nbsp;</td>\n");
	echo("<td width=\"10%\">&nbsp;</td>\n");
...
//				$errormsg = sql_query("CREATE TABLE admin (Username varchar(35) NOT NULL default '',Password char(32) binary NOT NULL default '',PRIMARY KEY  (Username)) TYPE=MyISAM;", $adminlink);
...
} elseif ($stage == 'stage_4_configuration_file') {
	...
	echo("<td><input type=\"button\" value=\"default\" onclick='document.configuration.stylesheet.value=\"style/default.css\";'></td>\n");
	echo("</tr>\n");
...
} elseif ($stage == 'stage_5_configure_administrators') {
	echo("<tr>\n");
	echo("<td width=\"35%\">&nbsp;</td>\n");
	echo("<td width=\"35%\">&nbsp;</td>\n");
	echo("<td width=\"30%\">&nbsp;</td>\n");
	...
	echo("</tr>\n");
} elseif ($stage == 'stage_6_pureftpd_config') {
	echo("<tr>\n");
	echo("<td width=\"10%\">&nbsp;</td>\n");
	echo("<td width=\"40%\">&nbsp;</td>\n");
	echo("<td width=\"40%\">&nbsp;</td>\n");
	...
	echo("\n");
	echo("\n");
	echo("# If you upgraded your tables to transactional tables (Gemini,\n");
	echo("# BerkeleyDB, Innobase...), you can enable SQL transactions to\n");
	echo("# avoid races. Leave this commented if you are using the\n");
	echo("# traditional MyIsam databases or old (< 3.23.x) MySQL versions.\n");
	echo("\n");
