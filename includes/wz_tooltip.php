...
var ttBgImg        = "<?=$LocationImages?>/help.gif";           // path to background image;
...
function tt_Htm(tt, t_id, txt)
{
	...
	// added padding-left:30px;
		'<tr><td'+(t_bgc? (' bgcolor="'+t_bgc+'"') : '')+(t_bgimg? ' background="'+t_bgimg+'"' : '')+' style="padding-left:30px;text-align:'+t_algn+';';
