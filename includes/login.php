...
/* 'User manager for PureFTPd' is made by M.Mastenbroek 2002 - 2005, dnsb 2022
...
if (!$query_admin)
	die("<br>Error: Table 'admin' from database '".$DBDatabase."' doesn't exist.<br><br>MySql error : ".sql_error($link));
                            ...
                            <td>
                                <table border="0" cellpadding="0" cellspacing="0" width="250">
                                    <tr>
                                        ...
                                        <td width="28" valign="bottom"><img src="<?= $LocationImages ?>/login.gif" width="28" height="11">
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <table border="0" width="100%">
                                                ...
                                                <tr>
                                                    <td width="40" align="center"><img src="<?= $LocationImages ?>/user.gif" width="16"
                                                                                       height="24"></td>
                                                    <td><?= $Translate[32] ?><br>
                                                ...
                                                <tr>
                                                    <td width="40" align="center"><img src="<?= $LocationImages ?>/key.gif" width="28"
                                                                                       height="32"></td>
                                                    <td><?= $Translate[41] ?><br>
