...
if (!isset($_SESSION['Login']) || $_SESSION['Login'] != '1') {
	...
	if (DEBUG) echo("Table users, nr of records is: ".sql_num_rows($query_users)."<br/>\n");
	...
	echo("<td class=\"border_ltb\" width=\"$small_area\">".$Translate[32]."</td>\n");
	echo("<td class=\"border_lrtb\" width=\"$middle_area\">\n&nbsp;");
	...
	echo("<tr class=\"edit_user\">\n");
	echo("<td class=\"border_ltb\" width=\"$small_area\">".$Translate[41]."</td>\n");
	...
	echo("<tr class=\"edit_user\">\n");
	echo("<td class=\"border_ltb\" width=\"$small_area\">".$Translate[42]."</td>\n");
	echo("<td class=\"border_lrtb\" colspan=\"2\">\n&nbsp;");
	...
	echo("<tr class=\"edit_user\">\n");
	echo("<td class=\"border_ltb\" width=\"$small_area\">".$Translate[33]."</td>\n");
	echo("<td class=\"border_lrtb\" colspan=\"2\">\n&nbsp;");
	...
	echo("<tr class=\"edit_user\">\n");
	echo("<td class=\"border_ltb\" width=\"$small_area\">".$Translate[34]."</td>\n");
	echo("<td class=\"border_lrtb\" colspan=\"2\">\n&nbsp;");
	...
	echo("<tr class=\"edit_user\">\n");
	echo("<td class=\"border_ltb\" width=\"$small_area\">".$Translate[35]."</td>\n");
	echo("<td class=\"border_ltb\" width=\"$middle_area\">\n&nbsp;");
	...
	echo("<tr class=\"edit_user\">\n");
	echo("<td class=\"border_l\" width=\"$small_area\">".$Translate[36]."</td>\n");
	echo("<td class=\"border_lr\" width=\"$large_area\">\n&nbsp;");
	echo("<input type=\"text\" name=\"ulbandwidth_box\" size=\"10\" maxlength=\"10\" value=\"$ulbandwidth\">\n");
	help($Translate[93]);
	echo("</td>\n");

	if ($EnableQuota == 1) {
		echo("<td class=\"border_lr\" width=\"$small_area\">".$Translate[43]."</td>\n");
	...
	echo("<tr class=\"edit_user\">\n");
	echo("<td class=\"border_ltb\" width=\"$small_area\">".$Translate[37]."</td>\n");
	...
	if ($EnableQuota == 1) {
		echo("<td class=\"border_lrtb\" width=\"$small_area\">".$Translate[44]."</td>\n");
		echo("<td class=\"border_rtb\">\n&nbsp;");
	...
	if ($EnableRatio == 1) {
		echo("<tr class=\"edit_user\">\n");
		echo("<td class=\"border_ltb\" width=\"$small_area\">".$Translate[45]."</td>\n");
		echo("<td class=\"border_lrtb\" width=\"$large_area\">\n&nbsp;");
	...
	echo("<tr class=\"edit_user\">\n");
	echo("<td class=\"border_ltb\" width=\"$small_area\">".$Translate[38]."</td>\n");
	echo("<td class=\"border_lrtb\" width=\"$large_area\">\n&nbsp;");
	...
	echo("</div>\n");
	echo("</form>\n");
	echo ("<script language=\"JavaScript\" type=\"text/javascript\" src=\"includes/wz_tooltip.js\"></script>\n");
